...
namespace libExcelController.ExcelController
{
    public class CExcelController
    {
        ...
        public static Excel.Worksheet GetWorkSheet(int index)
        {
            return (Excel.Worksheet)m_ExcelWorkbook.Worksheets[index];
        }
    }
}
